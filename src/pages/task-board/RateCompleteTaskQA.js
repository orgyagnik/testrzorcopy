...
export default function RateCompleteTaskQA({ ratingCompleteShow, setShowRatingCompleteModal, taskBoardId, setTaskBoardId, taskBoardUserId, setTaskBoardUserId, userData, reloadTaskboard, setReloadTaskboard }) {
    ...
    const handleSaveRatingCard = (e) => {
        ...
        if (communicationRating === 0) {
            ...
            APIService.doneQATaskboard(params)
                .then((response) => {
    ...
    return (
        <Modal size="xl" show={ratingCompleteShow} onHide={ratingCompleteClose} centered>
            ...
            <Modal.Body className="py-5 px-10">
